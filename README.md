...
Hello there! I'm Mohit, a passionate Java Backend Developer based in Madhya Pradesh, India. I specialize in designing and building RESTful APIs, microservices, and high-performance backend platforms using Java 17, Spring Boot, and PostgreSQL. Currently, I work at Tata Consultancy Services, building enterprise solutions for utility management platforms.

## Connect with Me

- Email: mohitsinghchandel785@gmail.com
- LinkedIn: [Mohit Singh](https://linkedin.com/in/mohit-singh-37966720b)
...
### Agentinsights.live
- **Position:** Android Developer – Internship (Nov 2023 – Apr 2024), Delhi, India
- **Achievements:** Built the core call-recording capture and background data transmission pipeline, improving audit-accuracy analytics for enterprise client workflows.

### NextGen Techno Ventures Pvt Ltd
- **Position:** Java Android Developer – Internship (Jul 2023 – Sep 2023), Mumbai, India
- **Achievements:** Developed the Filter App’s DND engine, integrating custom call/WhatsApp blocking logic, SIM-specific rules, and cloud-synced blocklists.

## Skills

- **Languages & Core Tech:** Core Java (17/21), REST APIs, Microservices Architecture
- **Frameworks:** Spring Boot, Spring MVC, Spring Data JPA, Hibernate, Spring Batch, Spring Security
- **Databases & Tools:** PostgreSQL, MySQL, SQL Optimization, Docker, Git, Maven, Jenkins
- **Testing & Security:** JUnit, Mockito, OAuth2, JWT, Postman, SLF4J/Logback

## Projects

- **TruWiz – Personalized Product Analysis Platform** (Jan 2025 – Present)
...
## Achievements & Programming Profiles
